...
var Scope = (function () {
  ...
  _createClass(Scope, [{
    ...
    value: function includes(baseIncludes) {
      ...
      var includes = _includesResolver2['default'].of(this.model).mergeDependencies(baseIncludes);
      ...
      _lodash2['default'].forEach(includes, function (input, fieldName) {
        if (_this4.model.fields[fieldName] && input === true) {
          ...
          _this4.fetchedFields[fieldName] = {
            ...
            expression: _this4.alias + '.' + (0, _clientJs.escapeId)(fieldCfg.column)
          };
          ...
          if (!relation.isCollection) {
            if (relation.foreignKey && _lodash2['default'].isEqual(input, { id: true })) {
              _this4.fetchedFields[fieldName] = {
                ...
                expression: _this4.alias + '.' + (0, _clientJs.escapeId)(relation.foreignKey)
              };
            } else {
          ...
          (function () {
            if (input instanceof _astJs.Aggregate) {
              _this4.isAggregate = true;
            }
            var parent = _this4;
            _this4.fetchedFields[fieldName] = Object.defineProperties({
              alias: _this4.queryHandler.nextAlias()
            }, {
              expression: {
                get: function get() {
