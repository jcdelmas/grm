...
var Scope = function () {
  ...
  function Scope(queryHandler, model) {
    var isRoot = arguments.length <= 2 || arguments[2] === undefined ? false : arguments[2];
  ...
  _createClass(Scope, [{
    ...
    value: function parseRow(row) {
      if (this.isRoot || row[this.fetchedFields.id.alias]) {
        // Required check for directly fetched optional relations
